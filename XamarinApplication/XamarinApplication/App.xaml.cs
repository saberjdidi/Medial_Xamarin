...
namespace XamarinApplication
{
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            //MTg3NDY0QDMxMzcyZTM0MmUzMG41SHVvaXNqMXB0TTczZEJ0Zk40VGt0TllLemVySDN4T3hhZTJrSDFxV0E9
            //MTk2ODQ5QDMxMzcyZTM0MmUzMFMwNllGaDJ3N1d6Q1JtVWFJSnlZZFBYcjA4TzdmbEZwRkFJSytnd1F4QkU9
            InitializeComponent();
            XF.Material.Forms.Material.Init(this); //Material Design
            // Device.SetFlags(new[] { "Expander_Experimental" }); //floating action menu
